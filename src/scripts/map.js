export default class Map {
  ...
  renderMap(mode) {
    mapboxgl.accessToken = 'pk.eyJ1IjoicGxhbnNoaWJhIiwiYSI6ImNrMWFtY3R6NTAwOHUzbXA1Y2h1ZnpqemsifQ.DcipLDMfbBNnNm4JNik_lQ';
    ...
    const allData = dataList.reduce((sum, item) => sum + item);

    const medianNumber = allData / dataList.length;
